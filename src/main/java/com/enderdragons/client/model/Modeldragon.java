...
public class Modeldragon<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("enderdragons", "modeldragon"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition spine = partdefinition.addOrReplaceChild("spine", CubeListBuilder.create(), PartPose.offset(0.0F, 19.0F, -13.0F));
		PartDefinition jaw = partdefinition.addOrReplaceChild("jaw", CubeListBuilder.create(), PartPose.offset(0.0F, 22.0F, -32.0F));
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-12.0F, -58.0F, -16.0F, 24.0F, 24.0F, 64.0F, new CubeDeformation(0.0F)).texOffs(220, 53)
						.addBox(-1.0F, -64.0F, -10.0F, 2.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(220, 53)
						.addBox(-1.0F, -64.0F, 10.0F, 2.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(220, 53)
						.addBox(-1.0F, -64.0F, 30.0F, 2.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 4.0F, 8.0F));
		PartDefinition left_wing = partdefinition.addOrReplaceChild("left_wing",
				CubeListBuilder.create().texOffs(112, 88).mirror().addBox(0.0F, -62.0F, -4.0F, 56.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(-56, 88).mirror().addBox(0.0F, -58.0F, 2.0F, 56.0F, 0.0F, 56.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offset(12.0F, 5.0F, 2.0F));
		PartDefinition left_wing_tip = partdefinition.addOrReplaceChild("left_wing_tip",
				CubeListBuilder.create().texOffs(112, 136).mirror().addBox(0.0F, -60.0F, -2.0F, 56.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(-56, 144).mirror().addBox(0.0F, -58.0F, 2.0F, 56.0F, 0.0F, 56.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offset(68.0F, 5.0F, 2.0F));
		PartDefinition right_wing = partdefinition.addOrReplaceChild(
				"right_wing", CubeListBuilder.create().texOffs(-56, 88).addBox(-56.0F, -58.0F, 2.0F, 56.0F, 0.0F, 56.0F, new CubeDeformation(0.0F))
						.texOffs(112, 88).addBox(-56.0F, -62.0F, -4.0F, 56.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-12.0F, 5.0F, 2.0F));
		PartDefinition right_wing_tip = partdefinition.addOrReplaceChild("right_wing_tip",
				CubeListBuilder.create().texOffs(-56, 144).addBox(-56.0F, -58.0F, 2.0F, 56.0F, 0.0F, 56.0F, new CubeDeformation(0.0F))
						.texOffs(112, 136).addBox(-56.0F, -60.0F, -2.0F, 56.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-68.0F, 5.0F, 2.0F));
		PartDefinition front_left_leg = partdefinition.addOrReplaceChild("front_left_leg",
				CubeListBuilder.create().texOffs(112, 104).addBox(-4.0F, -62.0F, -4.0F, 8.0F, 24.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(12.0F, 20.0F, 2.0F));
		PartDefinition front_left_shin = partdefinition.addOrReplaceChild("front_left_shin",
				CubeListBuilder.create().texOffs(226, 138).addBox(-3.0F, -59.0F, -3.0F, 6.0F, 24.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(12.0F, 41.0F, 2.0F));
		PartDefinition front_left_foot = partdefinition.addOrReplaceChild("front_left_foot",
				CubeListBuilder.create().texOffs(144, 104).addBox(-3.0F, -58.0F, -12.0F, 8.0F, 4.0F, 16.0F, new CubeDeformation(0.0F)),
				PartPose.offset(11.0F, 64.0F, 2.0F));
		PartDefinition back_left_leg = partdefinition.addOrReplaceChild("back_left_leg",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -62.0F, -8.0F, 16.0F, 32.0F, 16.0F, new CubeDeformation(0.0F)),
				PartPose.offset(16.0F, 16.0F, 42.0F));
		PartDefinition back_left_shin = partdefinition.addOrReplaceChild("back_left_shin",
				CubeListBuilder.create().texOffs(196, 0).addBox(-6.0F, -60.0F, 0.0F, 12.0F, 32.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(16.0F, 46.0F, 36.0F));
		PartDefinition back_left_foot = partdefinition.addOrReplaceChild("back_left_foot",
				CubeListBuilder.create().texOffs(112, 0).addBox(-9.0F, -58.0F, -20.0F, 18.0F, 6.0F, 24.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition front_right_foot = partdefinition.addOrReplaceChild("front_right_foot",
				CubeListBuilder.create().texOffs(144, 104).addBox(-4.0F, -58.0F, -12.0F, 8.0F, 4.0F, 16.0F, new CubeDeformation(0.0F)),
